...
python llm_benchmark.py --minimal -k $FIREWORKS_API_KEY -b https://api.fireworks.ai/inference/v1 -m "accounts/fireworks/models/llama-v2-70b-chat" "$@"
...
# llama2-13b
python llm_benchmark.py --minimal -k $FIREWORKS_API_KEY -b https://api.fireworks.ai/inference/v1 -m "accounts/fireworks/models/llama-v2-13b-chat" "$@"
...
# llama2-7b
python llm_benchmark.py --minimal -k $FIREWORKS_API_KEY -b https://api.fireworks.ai/inference/v1 -m "accounts/fireworks/models/llama-v2-7b-chat" "$@"
